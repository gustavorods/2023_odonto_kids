...
if (isset($_SESSION['id_consulta'])) {
    ...
    // Caso não tenha o ID da consulta, redireciona ou exibe uma mensagem de erro
    die("ID da consulta não encontrado na sessão.");
}
...
<body>
    ...
    <script>
        ...
        function handleFiles(files) {
            ...
            const idConsulta = <?php echo json_encode($_SESSION['id_consulta']); ?>;
            ...
            Array.from(files).forEach(file => {
                ...
                formData.append('id_consulta', idConsulta);  // Passa o id_consulta da sessão
